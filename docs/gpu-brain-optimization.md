...
| One CUDA thread per brain | Good for the current small brains | Many small independent 28-to-16-to-3 brains | Larger future brains may need cooperative threads | Keeps the current kernel and accumulation order simple |
